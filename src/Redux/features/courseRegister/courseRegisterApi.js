...
export const getSingleCourseRegister = async (obj) => {
  try {
    const response = await axios.get(
      `${API_BASE_URL}/${ACADEMICS_API_PATH_URL}/courseregistration/${obj?.selectedAcademicYear}/${obj?.selectedCourse}`,
      {
        headers: {
...
export const postSingleCourseRegister = async (obj) => {
  try {
    const response = await axios.post(
      `${API_BASE_URL}/${ACADEMICS_API_PATH_URL}/postcourseregistration/${obj?.selectedAcademicYear}`,
      obj?.data,
      {
        headers: {
          "Content-Type": "application/json",
