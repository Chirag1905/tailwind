    ...
    return (
        <div className='admin-wrapper bg-dark overflow-hidden before:fixed before:left-0 before:right-0 before:top-0 before:h-[198px]'>
            ...
            <div className='flex xl:h-[calc(100svh-72px)] md:h-[calc(100svh-68px)] h-[calc(100svh-60px)] relative'>
                <div className={`sm:w-[260px] h-[94vh] overflow-y-auto w-full min-w-[300px] xl:static fixed z-[3] xl:bg-transparent bg-dark xl:rounded-none sm:rounded-tl-2xl sm:rounded-t-none rounded-t-2xl xl:shadow-none transition-all duration-300 ${mobileNav ? 'shadow-shadow-lg sm:left-2 left-0' : '-left-full'}`}>
                    <Sidebar
