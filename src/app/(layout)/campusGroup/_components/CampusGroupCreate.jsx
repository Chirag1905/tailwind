...
import { IconChevronLeftPipe, IconChevronRightPipe, IconSquareRoundedCheck, IconSquareRoundedX } from '@tabler/icons-react';
...
const CampusGroupCreate = (props) => {
    ...
    const { campusGroupPostData, campusGroupFormData, loading, error } = useSelector(selectCampusGroup);
    ...
    const [formData, setFormData] = useState(campusGroupFormData || initialFormData);
    ...
    const handleSuccessOrClose = useCallback(() => {
        dispatch(resetCampusGroupFormData());
    ...
    useEffect(() => {
        dispatch(setCampusGroupFormData(formData));
    }, [formData, dispatch]);
    ...
    }, [campusGroupPostData, handleSuccessOrClose, token, dispatch]);
